set C_TypeInfoList {{ 
"acc2048_2048_mau" : [[], {"return": [["volatile"], {"scalar": "int"}] }, [{"ExternC" : 0}], [ {"alloc_1": [[],{ "pointer": "0"}] }],["1"],""],
...
set moduleName acc2048_2048_mau
...
set C_modelName {acc2048_2048_mau}

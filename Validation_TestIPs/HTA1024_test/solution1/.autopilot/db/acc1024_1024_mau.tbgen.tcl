set C_TypeInfoList {{ 
"acc1024_1024_mau" : [[], {"return": [["volatile"], {"scalar": "int"}] }, [{"ExternC" : 0}], [ {"alloc_1": [[],{ "pointer": "0"}] }],["1"],""],
 "1": [ "req_address", [[], {"array": [ {"scalar": "int"}, [1280]]}],""], 
"0": [ "allocator_port", {"typedef": [[[],"2"],""]}], 
"2": [ "", {"struct": [[],[],[{ "size": [[],  {"scalar": "int"}]},{ "addr": [[],  {"scalar": "int"}]},{ "free_target": [[],  {"scalar": "int"}]},{ "cmd": [[],  {"scalar": "char"}]}],""]}]
}}
set moduleName acc1024_1024_mau
...
set C_modelName {acc1024_1024_mau}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"WaitState" : [
			{"State" : "ap_ST_fsm_state4", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_HLS_malloc_1_s_fu_81"},
			{"State" : "ap_ST_fsm_state4", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_HLS_free_1_s_fu_95"}],
		"Port" : [
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_HLS_malloc_1_s_fu_81", "Parent" : "0",
		"CDFG" : "HLS_malloc_1_s",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_HLS_free_1_s_fu_95", "Parent" : "0",
		"CDFG" : "HLS_free_1_s",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",

...
#ifndef _checkKWTA_mini4_HH_
#define _checkKWTA_mini4_HH_
...
#include "checkKWTA_mini4_rbkb.h"
#include "checkKWTA_mini4_rcud.h"

namespace ap_rtl {

struct checkKWTA_mini4 : public sc_module {
    ...
    // Module declarations
    checkKWTA_mini4(sc_module_name name);
    SC_HAS_PROCESS(checkKWTA_mini4);
    ...
    checkKWTA_mini4_rbkb* req_cmd_U;
    checkKWTA_mini4_rcud* req_list_U;

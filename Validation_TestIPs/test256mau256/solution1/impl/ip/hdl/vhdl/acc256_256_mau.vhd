...
architecture behav of acc256_256_mau is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "acc256_256_mau,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.213000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=156,HLS_SYN_LUT=369,HLS_VERSION=2018_2}";
    ...
    signal req_list_q0 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    port (
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        free_target : IN STD_LOGIC_VECTOR (7 downto 0);
        allocator_size : OUT STD_LOGIC_VECTOR (31 downto 0);
        allocator_size_ap_vld : OUT STD_LOGIC;
        allocator_size_ap_ack : IN STD_LOGIC;
        allocator_free_targe : OUT STD_LOGIC_VECTOR (31 downto 0);
    ...
    component acc256_256_mau_rebkb IS
    generic (
        DataWidth : INTEGER;
    ...
    component acc256_256_mau_recud IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    req_cmd_U : component acc256_256_mau_rebkb
    generic map (
        DataWidth => 2,
        AddressRange => 1280,
        AddressWidth => 11)
    ...
    req_list_U : component acc256_256_mau_recud
    generic map (
        DataWidth => 8,
        AddressRange => 1280,
        AddressWidth => 11)

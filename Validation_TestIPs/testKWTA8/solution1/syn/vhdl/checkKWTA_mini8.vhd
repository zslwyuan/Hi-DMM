...
architecture behav of checkKWTA_mini8 is 
    ...
    signal req_cmd_address0 : STD_LOGIC_VECTOR (11 downto 0);
    signal req_cmd_ce0 : STD_LOGIC;
    signal req_cmd_q0 : STD_LOGIC_VECTOR (1 downto 0);
    signal req_list_address0 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    component checkKWTA_mini8_rbkb IS
    generic (
        DataWidth : INTEGER;
    ...
    component checkKWTA_mini8_rcud IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    req_cmd_U : component checkKWTA_mini8_rbkb
    generic map (
        DataWidth => 2,
        AddressRange => 4096,
        AddressWidth => 12)
    ...
    req_list_U : component checkKWTA_mini8_rcud
    generic map (
        DataWidth => 12,
        AddressRange => 4096,
        AddressWidth => 12)
    ...
    req_cmd_address0 <= tmp_fu_107_p1(12 - 1 downto 0);
    ...
    req_list_address0 <= tmp_fu_107_p1(12 - 1 downto 0);

...
#ifndef _checkKWTA_mini8_HH_
#define _checkKWTA_mini8_HH_
...
#include "checkKWTA_mini8_rbkb.h"
#include "checkKWTA_mini8_rcud.h"

namespace ap_rtl {

struct checkKWTA_mini8 : public sc_module {
    ...
    // Module declarations
    checkKWTA_mini8(sc_module_name name);
    SC_HAS_PROCESS(checkKWTA_mini8);
    ...
    sc_signal< sc_lv<12> > size_reg_172;

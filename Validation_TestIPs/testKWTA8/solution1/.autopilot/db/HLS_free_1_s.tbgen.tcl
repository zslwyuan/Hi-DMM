...
set C_modelArgMapList {[ 
	{ "Name" : "free_target", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ free_target sc_in sc_lv 12 signal 0 } 
	...
	{ allocator_free_targe sc_out sc_lv 32 signal 2 } 
	{ allocator_free_targe_ap_vld sc_out sc_logic 1 outvld 2 } 
	{ allocator_free_targe_ap_ack sc_in sc_logic 1 outacc 2 } 
	{ allocator_cmd sc_out sc_lv 8 signal 3 } 
	{ allocator_cmd_ap_vld sc_out sc_logic 1 outvld 3 } 
	{ allocator_cmd_ap_ack sc_in sc_logic 1 outacc 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "free_target", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "free_target", "role": "default" }} , 
...
set Spec2ImplPortList { 
	free_target { ap_none {  { free_target in_data 0 12 } } }

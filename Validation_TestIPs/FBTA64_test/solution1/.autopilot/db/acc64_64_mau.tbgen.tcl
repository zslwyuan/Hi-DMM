set C_TypeInfoList {{ 
"acc64_64_mau" : [[], {"return": [["volatile"], {"scalar": "int"}] }, [{"ExternC" : 0}], [ {"alloc_1": [[],{ "pointer": "0"}] }],["1"],""],
 "1": [ "req_address", [[], {"array": [ {"scalar": "int"}, [128]]}],""], 
"0": [ "allocator_port", {"typedef": [[[],"2"],""]}], 
"2": [ "", {"struct": [[],[],[{ "size": [[],  {"scalar": "int"}]},{ "addr": [[],  {"scalar": "int"}]},{ "free_target": [[],  {"scalar": "int"}]},{ "cmd": [[],  {"scalar": "char"}]}],""]}]
}}
set moduleName acc64_64_mau
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"WaitState" : [
			{"State" : "ap_ST_fsm_state4", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_HLS_malloc_1_s_fu_84"},
			{"State" : "ap_ST_fsm_state4", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_HLS_free_1_s_fu_98"}],
		"Port" : [
			{"Name" : "alloc_1_size", "Type" : "HS", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_HLS_free_1_s_fu_98", "Port" : "allocator_size"},
					{"ID" : "3", "SubInstance" : "grp_HLS_malloc_1_s_fu_84", "Port" : "allocator_size"}]},
			{"Name" : "alloc_1_addr", "Type" : "HS", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_HLS_malloc_1_s_fu_84", "Port" : "allocator_addr"}]},
			{"Name" : "alloc_1_free_target", "Type" : "HS", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_HLS_free_1_s_fu_98", "Port" : "allocator_free_targe"},
					{"ID" : "3", "SubInstance" : "grp_HLS_malloc_1_s_fu_84", "Port" : "allocator_free_targe"}]},
			{"Name" : "alloc_1_cmd", "Type" : "HS", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_HLS_free_1_s_fu_98", "Port" : "allocator_cmd"},
					{"ID" : "3", "SubInstance" : "grp_HLS_malloc_1_s_fu_84", "Port" : "allocator_cmd"}]},
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_HLS_malloc_1_s_fu_84", "Parent" : "0",
		"CDFG" : "HLS_malloc_1_s",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_HLS_free_1_s_fu_98", "Parent" : "0",
		"CDFG" : "HLS_free_1_s",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",

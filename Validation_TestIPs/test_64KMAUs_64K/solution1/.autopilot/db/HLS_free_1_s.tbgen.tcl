...
set C_modelArgList {
	{ free_target int 16 regular  }
	{ free_size int 14 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "free_target", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "free_size", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ free_target sc_in sc_lv 16 signal 0 } 
	{ free_size sc_in sc_lv 14 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "free_target", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "free_target", "role": "default" }} , 
 	{ "name": "free_size", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "free_size", "role": "default" }} , 
...
set Spec2ImplPortList { 
	free_target { ap_none {  { free_target in_data 0 16 } } }
	free_size { ap_none {  { free_size in_data 0 14 } } }

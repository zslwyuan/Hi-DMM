...
const sc_logic HLS_free_1_s::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic HLS_free_1_s::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<2> HLS_free_1_s::ap_ST_fsm_state1 = "1";
const sc_lv<2> HLS_free_1_s::ap_ST_fsm_state2 = "10";
const bool HLS_free_1_s::ap_const_boolean_1 = true;
const sc_lv<32> HLS_free_1_s::ap_const_lv32_0 = "00000000000000000000000000000000";
const sc_lv<8> HLS_free_1_s::ap_const_lv8_3 = "11";
const sc_lv<32> HLS_free_1_s::ap_const_lv32_1 = "1";

HLS_free_1_s::HLS_free_1_s(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    apTFilenSS << "HLS_free_1_s_sc_trace_" << apTFileNum ++;
    ...
    sc_trace(mVcdFile, free_target, "(port)free_target");
    sc_trace(mVcdFile, free_size, "(port)free_size");
...
HLS_free_1_s::~HLS_free_1_s() {
    if (mVcdFile) 
        sc_close_vcd_trace_file(mVcdFile);

}

void HLS_free_1_s::thread_ap_clk_no_reset_() {
...
void HLS_free_1_s::thread_allocator_cmd() {
    allocator_cmd = ap_const_lv8_3;
}

void HLS_free_1_s::thread_allocator_cmd_ap_vld() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
...
void HLS_free_1_s::thread_allocator_cmd_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
...
void HLS_free_1_s::thread_allocator_free_targe() {
    allocator_free_targe = esl_zext<32,15>(free_target.read());
}
...
void HLS_free_1_s::thread_allocator_free_targe_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
...
void HLS_free_1_s::thread_allocator_size() {
    allocator_size = esl_zext<32,12>(free_size.read());
}

void HLS_free_1_s::thread_allocator_size_ap_vld() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1) && 
...
void HLS_free_1_s::thread_allocator_size_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
...
void HLS_free_1_s::thread_ap_CS_fsm_state1() {
    ap_CS_fsm_state1 = ap_CS_fsm.read()[0];
}

void HLS_free_1_s::thread_ap_CS_fsm_state2() {
    ap_CS_fsm_state2 = ap_CS_fsm.read()[1];
}

void HLS_free_1_s::thread_ap_block_state1_io() {
...
void HLS_free_1_s::thread_ap_done() {
...
void HLS_free_1_s::thread_ap_idle() {
    if ((esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {
...
void HLS_free_1_s::thread_ap_ready() {
...
void HLS_free_1_s::thread_ap_sig_ioackin_allocator_cmd_ap_ack() {
...
void HLS_free_1_s::thread_ap_sig_ioackin_allocator_free_targe_ap_ack() {
...
void HLS_free_1_s::thread_ap_sig_ioackin_allocator_size_ap_ack() {
...
void HLS_free_1_s::thread_ap_NS_fsm() {

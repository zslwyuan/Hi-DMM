...
#ifndef _acc32kmau_HH_
#define _acc32kmau_HH_
...
#include "acc32kmau_req_cmd.h"
#include "acc32kmau_req_list.h"
#include "acc32kmau_req_size.h"

namespace ap_rtl {

struct acc32kmau : public sc_module {
    ...
    // Module declarations
    acc32kmau(sc_module_name name);
    SC_HAS_PROCESS(acc32kmau);
    ...
    acc32kmau_req_cmd* req_cmd_U;
    acc32kmau_req_list* req_list_U;
    acc32kmau_req_size* req_size_U;
    ...
    sc_signal< sc_lv<12> > req_size_load_reg_229;
    ...
    static const sc_lv<33> ap_const_lv33_1FFFFFED4;
    static const sc_lv<33> ap_const_lv33_2D4;
    // Thread declarations

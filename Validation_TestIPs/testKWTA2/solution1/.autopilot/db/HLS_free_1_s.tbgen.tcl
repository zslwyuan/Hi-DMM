...
set C_modelArgMapList {[ 
	{ "Name" : "free_target", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ free_target sc_in sc_lv 9 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "free_target", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "free_target", "role": "default" }} , 
...
set Spec2ImplPortList { 
	free_target { ap_none {  { free_target in_data 0 9 } } }

...
#ifndef _checkKWTA_mini2_HH_
#define _checkKWTA_mini2_HH_
...
#include "checkKWTA_mini2_rbkb.h"
#include "checkKWTA_mini2_rcud.h"

namespace ap_rtl {

struct checkKWTA_mini2 : public sc_module {
    ...
    // Module declarations
    checkKWTA_mini2(sc_module_name name);
    SC_HAS_PROCESS(checkKWTA_mini2);
    ...
    checkKWTA_mini2_rbkb* req_cmd_U;
    checkKWTA_mini2_rcud* req_list_U;

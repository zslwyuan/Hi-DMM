...
architecture behav of checkKWTA_mini2 is 
    ...
    component checkKWTA_mini2_rbkb IS
    generic (
        DataWidth : INTEGER;
    ...
    component checkKWTA_mini2_rcud IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    req_cmd_U : component checkKWTA_mini2_rbkb
    generic map (
        DataWidth => 2,
        AddressRange => 8192,
        AddressWidth => 13)
    ...
    req_list_U : component checkKWTA_mini2_rcud
    generic map (
        DataWidth => 9,
        AddressRange => 8192,
        AddressWidth => 13)

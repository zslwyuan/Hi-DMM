...
set C_modelArgMapList {[ 
	{ "Name" : "free_target", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
 	{ "Name" : "free_size", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ free_size sc_in sc_lv 11 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "free_size", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "free_size", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	free_size { ap_none {  { free_size in_data 0 11 } } }

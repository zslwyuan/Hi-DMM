...
static ap_uint<32> heap_tree[320]=	{	0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,
...
static ap_uint<64> group_tree[2048];

static ap_uint<64> top_heap[5]={0xFFFFFFFFFFFFFFFF,0xFFFFFFFFFFFFFFFF,0xFFFFFFFFFFFFFFFF,0xFFFFFFFFFFFFFFFF,0xFFFFFFFFFFFFFFFF};
...
volatile void Ext_KWTA64k(volatile allocator_port *alloc,volatile KTWA2HTA_port *com_port)//, volatile ap_uint<32> *port1, volatile ap_uint<64> *port2)
{
#pragma HLS ARRAY_PARTITION variable=top_heap complete dim=1
#pragma HLS ARRAY_PARTITION variable=heap_tree block factor=5 dim=1
...
#pragma HLS protocol fixed
	...
	//					*port2 = top_heap[2];
						...
						heap_tree[192+loc1] &= tmp0;
						top_heap[3].set_bit(loc1,(heap_tree[192+loc1]!=0));
	//					*port1 = 0xe7;
	//					*port2 = heap_tree[192+loc1];
	//					*port1 = 0xe8;
	//					*port2 = top_heap[3];

						heap_tree[256+loc1] &= tmp0;
						top_heap[4].set_bit(loc1,(heap_tree[256+loc1]!=0));
	//					*port1 = 0xe9;
	//					*port2 = heap_tree[256+loc1];
	//					*port1 = 0xe0;
	//					*port2 = top_heap[4];
					}
				}
	...
	//				*port2 = loc_in_layer;
					io_section55:{
						alloc->addr = (loc_in_layer<<(4-layer1));   // if output_addr<0, it means the allocation turns out to be a failure.
					}
					io_section_help2:
					{
//#pragma HLS protocol fixed
...
#pragma HLS protocol fixed
	...
	//				*port2 = 128+loc1;
					...
					heap_tree[192+loc1].set_bit(loc2,(bool)((tmp2&0x3FFFC000)!=0));
					top_heap[3].set_bit(loc1,(heap_tree[192+loc1]!=0));
	//				*port1 = 0x33;
	//				*port2 = heap_tree[192+loc1];
	//				*port1 = 0x333;
	//				*port2 = 192+loc1;
					...
					heap_tree[256+loc1].set_bit(loc2,(bool)((tmp0&0x3FFFFFFFC0000000)!=0));
					top_heap[4].set_bit(loc1,(heap_tree[256+loc1]!=0));
				}
...
#pragma HLS protocol fixed
	...
	//					*port2=top_heap[2];
						...
						top_heap[3].set_bit(loc1,(heap_tree[192+loc1]!=0));
	//					*port1=0xff1;
	//					*port2=heap_tree[loc1+192];
	//					*port1=0xff1;
	//					*port2=top_heap[3];
						heap_tree[256+loc1] |= tmp0;
						top_heap[4].set_bit(loc1,(heap_tree[256+loc1]!=0));
	//					*port1=0xff1;
	//					*port2=heap_tree[loc1+256];
	//					*port1=0xff1;
	//					*port2=top_heap[4];
					}
				}
				else
				{
					layer-=12;
					addr_HTA = free_target>>5;
					free_target= (free_target>>(4-layer));
	//				*port1 = 0xB;
	//				*port2 = free_target;

...
set RtlHierarchyInfo {[
	...
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.op_V_assign_log_2_64bit_fu_1175", "Parent" : "0",
		"CDFG" : "log_2_64bit",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.HTA512_theta_mux_kbM_U2", "Parent" : "0"},
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.HTA512_theta_mux_kbM_U3", "Parent" : "0"},
	{"ID" : "13", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.HTA512_theta_mux_kbM_U4", "Parent" : "0"},
	{"ID" : "14", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.HTA512_theta_mux_kbM_U5", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	HTA512_theta {
		alloc_size {Type I LastRead 1 FirstWrite -1}
		alloc_addr {Type O LastRead -1 FirstWrite 5}

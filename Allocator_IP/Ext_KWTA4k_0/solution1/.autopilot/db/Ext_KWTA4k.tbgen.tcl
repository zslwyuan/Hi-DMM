set C_TypeInfoList {{ 
"Ext_KWTA4k" : [[], {"return": [[], {"scalar": ""}] }, [{"ExternC" : 0}], [ {"alloc": [[],{ "pointer": "0"}] }, {"com_port": [[],{ "pointer": "1"}] }],[],""], 
"0": [ "allocator_port", {"typedef": [[[],"2"],""]}], 
"2": [ "", {"struct": [[],[],[{ "size": [[],  {"scalar": "int"}]},{ "free_target": [[],  {"scalar": "int"}]},{ "addr": [[],  {"scalar": "int"}]},{ "cmd": [[],  {"scalar": "char"}]}],""]}], 
"1": [ "KTWA2HTA_port", {"typedef": [[[],"3"],""]}], 
"3": [ "", {"struct": [[],[],[{ "layer": [[], "4"]},{ "target": [[], "5"]},{ "allocated_addr": [[], "5"]},{ "cmd": [[],  {"scalar": "char"}]}],""]}], 
"4": [ "ap_uint<8>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 8}}]],""]}}], 
"5": [ "ap_uint<16>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 16}}]],""]}}]
}}
set moduleName Ext_KWTA4k
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.group_tree_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mark_mask_V_U", "Parent" : "0"}]}

...
set C_modelName {KWTA_mini16_theta}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			...
			{"Name" : "last_offset_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "last_addr_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "used_free_V", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "last_loc1_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "last_loc2_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "heap_tree_V", "Type" : "Memory", "Direction" : "IO"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.used_free_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.heap_tree_V_U", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	KWTA_mini16_theta {
		...
		last_offset_V {Type IO LastRead -1 FirstWrite -1}
		last_addr_V {Type IO LastRead -1 FirstWrite -1}
		used_free_V {Type IO LastRead -1 FirstWrite -1}
		last_loc1_V {Type IO LastRead -1 FirstWrite -1}
		last_loc2_V {Type IO LastRead -1 FirstWrite -1}

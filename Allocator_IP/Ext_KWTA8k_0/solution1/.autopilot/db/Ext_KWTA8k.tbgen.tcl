set C_TypeInfoList {{ 
"Ext_KWTA8k" : [[], {"return": [[], {"scalar": ""}] }, [{"ExternC" : 0}], [ {"alloc": [[],{ "pointer": "0"}] }, {"com_port": [[],{ "pointer": "1"}] }],[],""], 
"1": [ "KTWA2HTA_port", {"typedef": [[[],"2"],""]}], 
"0": [ "allocator_port", {"typedef": [[[],"3"],""]}], 
"3": [ "", {"struct": [[],[],[{ "size": [[],  {"scalar": "int"}]},{ "free_target": [[],  {"scalar": "int"}]},{ "addr": [[],  {"scalar": "int"}]},{ "cmd": [[],  {"scalar": "char"}]}],""]}], 
"2": [ "", {"struct": [[],[],[{ "layer": [[], "4"]},{ "target": [[], "5"]},{ "allocated_addr": [[], "5"]},{ "cmd": [[],  {"scalar": "char"}]}],""]}], 
"5": [ "ap_uint<16>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 16}}]],""]}}], 
"4": [ "ap_uint<8>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 8}}]],""]}}]
}}
set moduleName Ext_KWTA8k
...
set RtlHierarchyInfo {[
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.group_tree_V_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.group_tree_mask_V_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.shift_constant_V_U", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mark_mask_V_U", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.extra_mask_V_U", "Parent" : "0"}]}

...
entity FBTA64_theta_buddcud_ram is 
    generic(
...
architecture rtl of FBTA64_theta_buddcud_ram is 
...
entity FBTA64_theta_buddcud is
    generic (
...
architecture arch of FBTA64_theta_buddcud is
    component FBTA64_theta_buddcud_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    FBTA64_theta_buddcud_ram_U :  component FBTA64_theta_buddcud_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

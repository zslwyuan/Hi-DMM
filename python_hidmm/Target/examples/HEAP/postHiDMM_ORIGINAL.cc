...
size_tail = SIZE_LIST;    last_parent = Hi_DMM_dynamic_heap_0 + offset_last_parent;  //HI-DMM insert: stress offset of pointer last_parent
    head = Hi_DMM_dynamic_heap_0 + offset_head;  //HI-DMM insert: stress offset of pointer head
    last_parent = head;
...
now = Hi_DMM_dynamic_heap_0 + offset_now;  //HI-DMM insert: stress offset of pointer now after pointer assignment 
size_now = SIZE_LIST;        now = Hi_DMM_dynamic_heap_0 + offset_now;  //HI-DMM insert: stress offset of pointer now

...
int mm0(int A[256])
{
    ...
    for (i = 0; i < 16; i++)
    {
        ...
        if (loop0_X_mod==0) offset_first_partition_loop0_X = offset_first_partition_loop0_X-LOOP0_UNROLL_FACTOR;
    ...
    if (loop1_X_mod==0) offset_first_partition_loop1_X = offset_first_partition_loop1_X-LOOP1_UNROLL_FACTOR;

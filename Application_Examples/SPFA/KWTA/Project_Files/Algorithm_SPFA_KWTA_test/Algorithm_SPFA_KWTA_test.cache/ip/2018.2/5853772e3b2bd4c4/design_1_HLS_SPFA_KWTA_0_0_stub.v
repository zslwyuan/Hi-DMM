...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(map_r_ce0, map_r_ce1, dis_output_ce0, 
  dis_output_we0, dis_output_ce1, dis_output_we1, alloc_HTA_size_ap_vld, 
  alloc_HTA_size_ap_ack, alloc_HTA_free_target_ap_vld, alloc_HTA_free_target_ap_ack, 
  alloc_HTA_addr_ap_vld, alloc_HTA_addr_ap_ack, alloc_HTA_cmd_ap_vld, 
  alloc_HTA_cmd_ap_ack, alloc_KWTA_size_ap_vld, alloc_KWTA_size_ap_ack, 
  alloc_KWTA_free_target_ap_vld, alloc_KWTA_free_target_ap_ack, alloc_KWTA_addr_ap_vld, 
  alloc_KWTA_addr_ap_ack, alloc_KWTA_cmd_ap_vld, alloc_KWTA_cmd_ap_ack, ap_clk, ap_rst, 
  ap_start, ap_done, ap_idle, ap_ready, n, map_r_address0, map_r_q0, map_r_address1, map_r_q1, 
  dis_output_address0, dis_output_d0, dis_output_q0, dis_output_address1, dis_output_d1, 
  dis_output_q1, alloc_HTA_size, alloc_HTA_free_target, alloc_HTA_addr, alloc_HTA_cmd, 
  alloc_KWTA_size, alloc_KWTA_free_target, alloc_KWTA_addr, alloc_KWTA_cmd)
/* synthesis syn_black_box black_box_pad_pin="map_r_ce0,map_r_ce1,dis_output_ce0,dis_output_we0,dis_output_ce1,dis_output_we1,alloc_HTA_size_ap_vld,alloc_HTA_size_ap_ack,alloc_HTA_free_target_ap_vld,alloc_HTA_free_target_ap_ack,alloc_HTA_addr_ap_vld,alloc_HTA_addr_ap_ack,alloc_HTA_cmd_ap_vld,alloc_HTA_cmd_ap_ack,alloc_KWTA_size_ap_vld,alloc_KWTA_size_ap_ack,alloc_KWTA_free_target_ap_vld,alloc_KWTA_free_target_ap_ack,alloc_KWTA_addr_ap_vld,alloc_KWTA_addr_ap_ack,alloc_KWTA_cmd_ap_vld,alloc_KWTA_cmd_ap_ack,ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,n[31:0],map_r_address0[14:0],map_r_q0[31:0],map_r_address1[14:0],map_r_q1[31:0],dis_output_address0[7:0],dis_output_d0[31:0],dis_output_q0[31:0],dis_output_address1[7:0],dis_output_d1[31:0],dis_output_q1[31:0],alloc_HTA_size[31:0],alloc_HTA_free_target[31:0],alloc_HTA_addr[31:0],alloc_HTA_cmd[7:0],alloc_KWTA_size[31:0],alloc_KWTA_free_target[31:0],alloc_KWTA_addr[31:0],alloc_KWTA_cmd[7:0]" */;
  output map_r_ce0;
  output map_r_ce1;

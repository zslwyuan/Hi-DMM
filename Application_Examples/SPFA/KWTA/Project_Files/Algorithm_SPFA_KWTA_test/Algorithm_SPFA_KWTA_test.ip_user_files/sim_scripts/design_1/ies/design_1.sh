...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../Algorithm_SPFA_KWTA_test.srcs/sources_1/bd/design_1/ipshared/b65a" \
       +incdir+"../../../../Algorithm_SPFA_KWTA_test.srcs/sources_1/bd/design_1/ipshared/b65a"
}

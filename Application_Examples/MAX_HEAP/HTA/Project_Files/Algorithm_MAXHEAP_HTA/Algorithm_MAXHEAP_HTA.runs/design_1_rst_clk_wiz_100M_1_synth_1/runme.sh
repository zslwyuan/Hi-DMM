...
HD_PWD='/home/tingyuan/Temporary/vivado-outputs/Algorithm_MAXHEAP_HTA/Algorithm_MAXHEAP_HTA.runs/design_1_rst_clk_wiz_100M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rst_clk_wiz_100M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rst_clk_wiz_100M_1.tcl

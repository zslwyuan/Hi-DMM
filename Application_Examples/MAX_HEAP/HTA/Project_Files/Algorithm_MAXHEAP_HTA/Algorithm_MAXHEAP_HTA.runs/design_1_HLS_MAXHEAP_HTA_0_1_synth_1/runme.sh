...
HD_PWD='/home/tingyuan/Temporary/vivado-outputs/Algorithm_MAXHEAP_HTA/Algorithm_MAXHEAP_HTA.runs/design_1_HLS_MAXHEAP_HTA_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_HLS_MAXHEAP_HTA_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_HLS_MAXHEAP_HTA_0_1.tcl

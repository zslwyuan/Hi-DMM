...
#ifndef _HLS_malloc_3_s_HH_
#define _HLS_malloc_3_s_HH_
...
struct HLS_malloc_3_s : public sc_module {
    ...
    // Module declarations
    HLS_malloc_3_s(sc_module_name name);
    SC_HAS_PROCESS(HLS_malloc_3_s);
    ...
    sc_signal< sc_lv<32> > status_reg_58;

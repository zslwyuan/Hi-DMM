...
const sc_logic HLS_malloc_2_s::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic HLS_malloc_2_s::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<3> HLS_malloc_2_s::ap_ST_fsm_state1 = "1";
const sc_lv<3> HLS_malloc_2_s::ap_ST_fsm_state2 = "10";
const sc_lv<3> HLS_malloc_2_s::ap_ST_fsm_state3 = "100";
const bool HLS_malloc_2_s::ap_const_boolean_1 = true;
const sc_lv<32> HLS_malloc_2_s::ap_const_lv32_0 = "00000000000000000000000000000000";
const sc_lv<32> HLS_malloc_2_s::ap_const_lv32_1 = "1";
const sc_lv<8> HLS_malloc_2_s::ap_const_lv8_2 = "10";
const sc_lv<32> HLS_malloc_2_s::ap_const_lv32_8 = "1000";
const sc_lv<32> HLS_malloc_2_s::ap_const_lv32_2 = "10";

HLS_malloc_2_s::HLS_malloc_2_s(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    apTFilenSS << "HLS_malloc_2_s_sc_trace_" << apTFileNum ++;
...
HLS_malloc_2_s::~HLS_malloc_2_s() {
    if (mVcdFile) 
        sc_close_vcd_trace_file(mVcdFile);

}

void HLS_malloc_2_s::thread_ap_clk_no_reset_() {
...
void HLS_malloc_2_s::thread_allocator_addr_ap_ack() {
...
void HLS_malloc_2_s::thread_allocator_addr_blk_n() {
...
void HLS_malloc_2_s::thread_allocator_cmd() {
    allocator_cmd = ap_const_lv8_2;
}

void HLS_malloc_2_s::thread_allocator_cmd_ap_vld() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
...
void HLS_malloc_2_s::thread_allocator_cmd_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
...
void HLS_malloc_2_s::thread_allocator_free_targe() {
    allocator_free_targe = ap_const_lv32_0;
}

void HLS_malloc_2_s::thread_allocator_free_targe_ap_vld() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1) && 
...
void HLS_malloc_2_s::thread_allocator_free_targe_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
...
void HLS_malloc_2_s::thread_allocator_size() {
    allocator_size = ap_const_lv32_8;
}

void HLS_malloc_2_s::thread_allocator_size_ap_vld() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1) && 
...
void HLS_malloc_2_s::thread_allocator_size_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
...
void HLS_malloc_2_s::thread_ap_CS_fsm_state1() {
    ap_CS_fsm_state1 = ap_CS_fsm.read()[0];
}

void HLS_malloc_2_s::thread_ap_CS_fsm_state2() {
    ap_CS_fsm_state2 = ap_CS_fsm.read()[1];
}

void HLS_malloc_2_s::thread_ap_CS_fsm_state3() {
    ap_CS_fsm_state3 = ap_CS_fsm.read()[2];
}

void HLS_malloc_2_s::thread_ap_block_state1_io() {
...
void HLS_malloc_2_s::thread_ap_done() {
...
void HLS_malloc_2_s::thread_ap_idle() {
    if ((esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {
...
void HLS_malloc_2_s::thread_ap_ready() {
...
void HLS_malloc_2_s::thread_ap_return() {
    ap_return = status_reg_58.read();
}

void HLS_malloc_2_s::thread_ap_sig_ioackin_allocator_cmd_ap_ack() {
...
void HLS_malloc_2_s::thread_ap_sig_ioackin_allocator_free_targe_ap_ack() {
...
void HLS_malloc_2_s::thread_ap_sig_ioackin_allocator_size_ap_ack() {
...
void HLS_malloc_2_s::thread_ap_NS_fsm() {

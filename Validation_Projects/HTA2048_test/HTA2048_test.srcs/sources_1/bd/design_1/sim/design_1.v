...
module design_1
  ...
  wire acc2048_2048_mau_0_alloc_1_addr_ap_ack;
  wire [7:0]acc2048_2048_mau_0_alloc_1_cmd;
  wire acc2048_2048_mau_0_alloc_1_cmd_ap_vld;
  wire [31:0]acc2048_2048_mau_0_alloc_1_free_target;
  wire acc2048_2048_mau_0_alloc_1_free_target_ap_vld;
  wire [31:0]acc2048_2048_mau_0_alloc_1_size;
  wire acc2048_2048_mau_0_alloc_1_size_ap_vld;
  wire [31:0]acc2048_2048_mau_0_ap_return;
  wire ap_start_0_1;
  wire clk_in1_0_1;
  ...
  assign ap_return_0[31:0] = acc2048_2048_mau_0_ap_return;
  ...
  design_1_HTA2048_theta_0_0 HTA2048_theta_0
       (.alloc_addr(HTA2048_theta_0_alloc_addr),
        .alloc_addr_ap_ack(acc2048_2048_mau_0_alloc_1_addr_ap_ack),
        .alloc_addr_ap_vld(HTA2048_theta_0_alloc_addr_ap_vld),
        .alloc_cmd(acc2048_2048_mau_0_alloc_1_cmd),
        .alloc_cmd_ap_ack(HTA2048_theta_0_alloc_cmd_ap_ack),
        .alloc_cmd_ap_vld(acc2048_2048_mau_0_alloc_1_cmd_ap_vld),
        .alloc_free_target(acc2048_2048_mau_0_alloc_1_free_target),
        .alloc_free_target_ap_ack(HTA2048_theta_0_alloc_free_target_ap_ack),
        .alloc_free_target_ap_vld(acc2048_2048_mau_0_alloc_1_free_target_ap_vld),
        .alloc_size(acc2048_2048_mau_0_alloc_1_size),
        .alloc_size_ap_ack(HTA2048_theta_0_alloc_size_ap_ack),
        .alloc_size_ap_vld(acc2048_2048_mau_0_alloc_1_size_ap_vld),
        .ap_clk(clk_wiz_clk_out1),
        .ap_rst(rst_clk_wiz_100M_peripheral_reset),
        .ap_start(ap_start_0_1));
  design_1_acc2048_2048_mau_0_0 acc2048_2048_mau_0
       (.alloc_1_addr(HTA2048_theta_0_alloc_addr),
        .alloc_1_addr_ap_ack(acc2048_2048_mau_0_alloc_1_addr_ap_ack),
        .alloc_1_addr_ap_vld(HTA2048_theta_0_alloc_addr_ap_vld),
        .alloc_1_cmd(acc2048_2048_mau_0_alloc_1_cmd),
        .alloc_1_cmd_ap_ack(HTA2048_theta_0_alloc_cmd_ap_ack),
        .alloc_1_cmd_ap_vld(acc2048_2048_mau_0_alloc_1_cmd_ap_vld),
        .alloc_1_free_target(acc2048_2048_mau_0_alloc_1_free_target),
        .alloc_1_free_target_ap_ack(HTA2048_theta_0_alloc_free_target_ap_ack),
        .alloc_1_free_target_ap_vld(acc2048_2048_mau_0_alloc_1_free_target_ap_vld),
        .alloc_1_size(acc2048_2048_mau_0_alloc_1_size),
        .alloc_1_size_ap_ack(HTA2048_theta_0_alloc_size_ap_ack),
        .alloc_1_size_ap_vld(acc2048_2048_mau_0_alloc_1_size_ap_vld),
        .ap_clk(clk_wiz_clk_out1),
        .ap_return(acc2048_2048_mau_0_ap_return),
        .ap_rst(rst_clk_wiz_100M_peripheral_reset),
        .ap_start(ap_start_0_1));

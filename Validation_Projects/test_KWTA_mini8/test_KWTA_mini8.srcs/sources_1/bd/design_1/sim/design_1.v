...
module design_1
  ...
  wire KWTA_mini8_theta_0_alloc_cmd_ap_ack;
  wire KWTA_mini8_theta_0_alloc_free_target_ap_ack;
  wire KWTA_mini8_theta_0_alloc_size_ap_ack;
  wire [31:0]KWTA_theta_0_alloc_addr;
  wire KWTA_theta_0_alloc_addr_ap_vld;
  wire ap_start_1_1;
  wire checkKWTA_mini8_0_alloc_1_addr_ap_ack;
  wire [7:0]checkKWTA_mini8_0_alloc_1_cmd;
  wire checkKWTA_mini8_0_alloc_1_cmd_ap_vld;
  wire [31:0]checkKWTA_mini8_0_alloc_1_free_target;
  wire checkKWTA_mini8_0_alloc_1_free_target_ap_vld;
  wire [31:0]checkKWTA_mini8_0_alloc_1_size;
  wire checkKWTA_mini8_0_alloc_1_size_ap_vld;
  wire [31:0]checkKWTA_mini8_0_ap_return;
  wire clk_in1_0_1;
  ...
  assign ap_return_0[31:0] = checkKWTA_mini8_0_ap_return;
  assign ap_start_1_1 = ap_start_1;
  assign clk_in1_0_1 = clk_in1_0;
  assign ext_reset_in_0_1 = ext_reset_in_0;
  assign reset_0_1 = reset_0;
  design_1_KWTA_mini8_theta_0_0 KWTA_mini8_theta_0
       (.alloc_addr(KWTA_theta_0_alloc_addr),
        .alloc_addr_ap_ack(checkKWTA_mini8_0_alloc_1_addr_ap_ack),
        .alloc_addr_ap_vld(KWTA_theta_0_alloc_addr_ap_vld),
        .alloc_cmd(checkKWTA_mini8_0_alloc_1_cmd),
        .alloc_cmd_ap_ack(KWTA_mini8_theta_0_alloc_cmd_ap_ack),
        .alloc_cmd_ap_vld(checkKWTA_mini8_0_alloc_1_cmd_ap_vld),
        .alloc_free_target(checkKWTA_mini8_0_alloc_1_free_target),
        .alloc_free_target_ap_ack(KWTA_mini8_theta_0_alloc_free_target_ap_ack),
        .alloc_free_target_ap_vld(checkKWTA_mini8_0_alloc_1_free_target_ap_vld),
        .alloc_size(checkKWTA_mini8_0_alloc_1_size),
        .alloc_size_ap_ack(KWTA_mini8_theta_0_alloc_size_ap_ack),
        .alloc_size_ap_vld(checkKWTA_mini8_0_alloc_1_size_ap_vld),
  ...
  design_1_checkKWTA_mini8_0_0 checkKWTA_mini8_0
       (.alloc_1_addr(KWTA_theta_0_alloc_addr),
        .alloc_1_addr_ap_ack(checkKWTA_mini8_0_alloc_1_addr_ap_ack),
        .alloc_1_addr_ap_vld(KWTA_theta_0_alloc_addr_ap_vld),
        .alloc_1_cmd(checkKWTA_mini8_0_alloc_1_cmd),
        .alloc_1_cmd_ap_ack(KWTA_mini8_theta_0_alloc_cmd_ap_ack),
        .alloc_1_cmd_ap_vld(checkKWTA_mini8_0_alloc_1_cmd_ap_vld),
        .alloc_1_free_target(checkKWTA_mini8_0_alloc_1_free_target),
        .alloc_1_free_target_ap_ack(KWTA_mini8_theta_0_alloc_free_target_ap_ack),
        .alloc_1_free_target_ap_vld(checkKWTA_mini8_0_alloc_1_free_target_ap_vld),
        .alloc_1_size(checkKWTA_mini8_0_alloc_1_size),
        .alloc_1_size_ap_ack(KWTA_mini8_theta_0_alloc_size_ap_ack),
        .alloc_1_size_ap_vld(checkKWTA_mini8_0_alloc_1_size_ap_vld),
        .ap_clk(clk_wiz_clk_out1),
        .ap_return(checkKWTA_mini8_0_ap_return),
        .ap_rst(rst_clk_wiz_100M_peripheral_reset),
        .ap_start(ap_start_1_1));

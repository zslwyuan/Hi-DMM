...
HD_PWD='/home/tingyuan/Temporary/vivado-outputs/test_KWTA_mini8/test_KWTA_mini8.runs/design_1_checkKWTA_mini8_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_checkKWTA_mini8_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_checkKWTA_mini8_0_0.tcl

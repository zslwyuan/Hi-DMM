...
HD_PWD='/home/tingyuan/Temporary/vivado-outputs/test16kmau/test16kmau.runs/design_1_acc16kmau_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_acc16kmau_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_acc16kmau_0_0.tcl

...
(* CORE_GENERATION_INFO="KWTA_mini4_theta,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.356500,HLS_SYN_LAT=5,HLS_SYN_TPT=none,HLS_SYN_MEM=10,HLS_SYN_DSP=0,HLS_SYN_FF=583,HLS_SYN_LUT=1659,HLS_VERSION=2018_2}" *)
...
reg   [63:0] p_Result_s_35_fu_1023_p4;
...
always @ (posedge ap_clk) begin
    if (((tmp_3_fu_887_p2 == 1'd1) & (tmp_fu_878_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2) & (1'b0 == ap_block_state2_io))) begin
        p_Result_6_reg_1488 <= {{alloc_free_target_re_reg_1466[7:2]}};
        p_Result_7_reg_1493 <= {{alloc_free_target_re_reg_1466[13:8]}};
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        heap_tree_V_d0 = p_Result_s_35_fu_1023_p4;
    end else begin
        heap_tree_V_d0 = 'bx;
    end
end
...
always @ (*) begin
    p_Result_s_35_fu_1023_p4 = heap_tree_V_q0;
    p_Result_s_35_fu_1023_p4[i_assign_fu_1020_p1] = |(1'd1);
end

...
vlog -work xil_defaultlib -64 -incr -sv "+incdir+../../../../test64kmau.srcs/sources_1/bd/design_1/ipshared/b65a" "+incdir+../../../../test64kmau.srcs/sources_1/bd/design_1/ipshared/b65a" \
"/opt/Xilinx/Vivado/2018.2/data/ip/xpm/xpm_cdc/hdl/xpm_cdc.sv" \

vcom -work xpm -64 -93 \
"/opt/Xilinx/Vivado/2018.2/data/ip/xpm/xpm_VCOMP.vhd" \

vlog -work xil_defaultlib -64 -incr "+incdir+../../../../test64kmau.srcs/sources_1/bd/design_1/ipshared/b65a" "+incdir+../../../../test64kmau.srcs/sources_1/bd/design_1/ipshared/b65a" \
